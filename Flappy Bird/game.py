...
bird_image = pygame.image.load('assets\yellowbird-upflap.png')
...
class Game:
    ...
    def init_game(self):
        ...
        self.bird = Player(bird_image)
        self.ground = Base(ground_image, 0)
        self.pipes = []
        self.score = 0
        self.turn = 0
...
game.train_agent(True, 100, 100, hyperparameter)  
